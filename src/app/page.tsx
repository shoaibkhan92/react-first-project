  ...
  return (
    ...
    {/* -------------------------- */}
      <div className="max-w-md mx-auto bg-[#000000]">
        ...
        <span style={{ backgroundImage: "url(/assets/logo/jupiter-select-logo.png)" }} className="bg-no-repeat bg-contain w-[130px] h-12 absolute inline-block top-28 left-1/2 -translate-x-1/2"></span>
        ...
        <div>
          ...
          <span style={{ backgroundImage: "url(/assets/icons/upi-icon.png)" }} className="bg-no-repeat bg-contain w-6 h-6 inline-block align-middle"></span>
          </p>
        ...
        <div className="text-center relative z-10">
          ...
          <div className="bg-white/[0.04] border border-[#333333] backdrop-blur text-left px-4 py-5 rounded-lg flex gap-2 items-center mb-2">
          ...
          <div className="bg-white/[0.04] border border-[#333333] backdrop-blur text-left px-4 py-5 rounded-lg flex gap-2 items-center">
